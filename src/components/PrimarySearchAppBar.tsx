        ...
        <Box sx={{ flexGrow: 1 }}>
            <AppBar position="static" color="primary">
                <Toolbar>
                    ...
                    <Link to="/react-ecommerce/"><img src="/react-ecommerce/logo.svg" alt="Ecommerce logo" height={40} /> <Typography sx={{ fontWeight: 700, fontSize: 20, display: 'inline-block', color: 'white' }}>Global Commerce</Typography></Link>
                    <Link to="/react-ecommerce/"><img src="logo.svg" alt="Ecommerce logo" height={40} /> <Typography sx={{ fontWeight: 700, fontSize: 20, display: 'inline-block', color: 'white' }}>Global Commerce</Typography></Link>
